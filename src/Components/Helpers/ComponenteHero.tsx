...
const Hero:FC = () => {
    const HeroObjectivestData:ObjectivesData[] = [
        {Icon:IoBulb, Span:"Innovación continúa", Color:"text-[#91D9FF]"},
        {Icon:IoShieldCheckmark, Span:"Calidad y rendimiento", Color:"text-[#91D9FF]"},
        {Icon:FaHandshakeSimple, Span:"Satisfacción del cliente", Color:"text-[#91D9FF]"},
        {Icon:IoCube, Span:"Diversificación de productos", Color:"text-[#91D9FF]"},
        {Icon:FaGear, Span:"Automatización", Color:"text-[#91D9FF]"},
    ]
    return(
        <div className=' w-full h-screen flex flex-col justify-end items-center gap-8'>
            <div className='w-[70%] h-2/4 grid grid-cols-[50%_50%] max-[888px]:flex max-[888px]:flex-col max-[888px]:justify-center max-[888px]:items-center'>
                <div className=' flex flex-col items-center justify-center'>
                    <h1 className='text-4xl text-white font-Poppins-Bold leading-snug max-[888px]:hidden'>Transforma tu mundo digital con <span className='text-[#31b7e0]'> Cosmic Wave Labs</span></h1>
                    <br />
                    <h1 className='text-4xl text-[#31b7e0] font-Poppins-Bold leading-snug max-[888px]:block min-[889px]:hidden max-[516px]:text-2xl'>Cosmic Wave Labs</h1>
            ...
            <div className='w-[85%] h-44 rounded-xl bg-[#0c1629] mb-12 flex items-center justify-around font-Poppins-Extra-Light max-[888px]:h-36 max-[645px]:h-28 max-[404px]:h-24'>
